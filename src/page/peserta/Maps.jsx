          ...
          <Row className="mt-3 bg-light">
            <Col className="p-5">
              ...
              <form onSubmit={formHandler}>
                ...
                {quest !== 5 && <button type="submit" onClick={goNext}>Upload</button> }
...
function QuestTwo({ data, update }) {
  return (
    <div>
        <p className="my-1" style={{textDecorationLine: 'line-through'}}>Hobi apa yang kamu tekuni di waktu selang yang kamu miliki?</p>
...
function QuestThree({ data, update }) {
  return (
    <div>
        <p className="my-1" style={{textDecorationLine: 'line-through'}}>Hobi apa yang kamu tekuni di waktu selang yang kamu miliki?</p>
        <p className="my-1" style={{textDecorationLine: 'line-through'}}>Menurutmu, bagaimana orang melihatmu?</p>
        <p className="my-1">Hobi apa yang kamu tekuni di waktu selang yang kamu miliki?</p>
    </div>
  );
}
...
function Done({ data, update }) {
  return (
    <div>
        ...
        <p className="my-1" style={{textDecorationLine: 'line-through'}}>Menurutmu, bagaimana orang melihatmu?</p>
        <p className="my-1" style={{textDecorationLine: 'line-through'}}>Hobi apa yang kamu tekuni di waktu selang yang kamu miliki?</p>
        <p className="my-1" style={{textDecorationLine: 'line-through'}}>Ceritakan pengalaman paling berkesan selama sekolah online!</p>
    </div>
  );
}